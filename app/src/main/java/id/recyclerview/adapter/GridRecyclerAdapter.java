...
public class GridRecyclerAdapter extends RecyclerView.Adapter {
    ...
    public GridRecyclerAdapter(List<UGCModel> list) {
        this.list = list;
    }

    public GridRecyclerAdapter(RecyclerView recyclerView, List<UGCModel> list) {
        this.list = list;
    ...
    public void load(List list, RecyclerView.Adapter adapter, final int limit) {
        ...
        final GridRecyclerAdapter adapter2 = (GridRecyclerAdapter) adapter;
